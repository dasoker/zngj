            ...
            public void onFinish(Bitmap bitmap) {
                ...
                if (FileUtils.createOrExistsDir(Constant.DIR_ROOT)) {
                    ...
                    if (mType == TYPE_IDCARD_FRONT) {
                        imagePath = buffer.append(Constant.DIR_ROOT).append(Constant.APP_NAME).append(".").append("idCardFrontCrop.png").toString();
                        if (ImageUtils.save(bitmap, imagePath, Bitmap.CompressFormat.PNG)) {
                        ...
                        imagePath = buffer.append(Constant.DIR_ROOT).append(Constant.APP_NAME).append(".").append("idCardBackCrop.png").toString();
                        if (ImageUtils.save(bitmap, imagePath, Bitmap.CompressFormat.PNG)) {
                            Intent intent = new Intent();
                            intent.putExtra(CameraActivity.IMAGE_PATH, imagePath);
