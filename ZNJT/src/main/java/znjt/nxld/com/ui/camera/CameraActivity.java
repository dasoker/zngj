package znjt.nxld.com.ui.camera;
...
import znjt.nxld.com.util.FileUtil;
import znjt.nxld.com.util.StringAndBitmap;

/**
 * Created by zhengzhihua on 2018/9/14.16:59
 * Update 2018/9/14 16:59
 * Describe
 */
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (bitmap != null) {
                            ...
                            //裁剪及保存到文件
                             resBitmap = Bitmap.createBitmap(bitmap,
                            ...
                            FileUtil.saveBitmap(StringAndBitmap.comp(resBitmap));
